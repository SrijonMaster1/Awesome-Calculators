...
def preferences(event):
    ...
    apply = Button(options, command=options.destroy,
                   text='Apply', bg='#1fdd48', fg='white')
...
for item in buttons:
    ...
    button = Button(window, text=item, highlightbackground=background,
                    fg=foreground, command=lambda i=item: update(i))
